...
export default function Nav() {
    ...
    // Close mobile menu when path changes (user navigates)
    useEffect(() => {
        if (show) {
            setShow(false);
            document.body.style.overflow = "auto";
        ...
        <div className="flex justify-between align-center py-5 mx-5">
            ...
            {session?.user && role !== "admin" ? (
                <div className="hidden sm:flex sm:gap-5 lg:gap-10 justify-center items-center navbar">
                    <Link
                        href="/"
                        className={`nav_items hover:underline transition-all ${pathname === "/" ? "underline" : ""}`}
                    >
                        Home
                    </Link>
                    {/* <Link
                    ...
                    {pathname === "/admin" ? (
                        ...
                        <>
                            ...
                            <div
                                className={`${
                                    show ? "block" : "hidden"
                                } absolute z-50 bg-white border flex flex-col gap-4 w-full left-0 top-0 h-full items-center pt-5`}
                            >
                                ...
                                <div
                                    className="border p-3 rounded-full flex items-center px-4 shadow-xl absolute bottom-10"
                                    onClick={handleShow}
                                >
                                    <FontAwesomeIcon
                                        className="text-2xl"
