...
export default function UserProfile({
    ...
    return (
        <div className="text-center mt-8 sm:mx-10 w-full">
            <div className="details flex flex-col md:flex-row justify-between items-center mx-2 md:mx-4 lg:flex-col lg:gap-20">
                <div className="profile_image flex items-center gap-3 lg:flex-col lg:gap-5">
                    ...
                    <div className="detail text-start lg:text-center">
                        ...
                        <div className="role text-[12px] sm:text-[15px] text-gray-500 mt-1 px-12 py-1 flex justify-start">
                            {docInfo.isDoctorApproved === "accepted" ? (
                                <p className="border rounded-lg bg-green-300">
                                    Doctor
                                </p>
                            ) : docInfo.isDoctorApproved === "pending" ? (
                                <p className="border rounded-lg bg-yellow-300">
                                    Doctor (Pending)
                                </p>
                            ) : (
                                <p className="border rounded-lg bg-gray-300 flex justify-center px-4">
                                    Patient
                                </p>
                            )}
                        </div>
                ...
                <div className="acc_actions flex flex-col gap-2 md:flex-row md:gap-4 lg:flex-col">
                    <button
                        onClick={logOut}
