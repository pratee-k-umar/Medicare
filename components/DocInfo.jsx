...
export default function DocInfo({
    ...
    useEffect(() => {
        const fetchBooking = async () => {
            const fetchData = await fetch(
                `/api/appointments/get/${session.user.id}`,
            );
    ...
    return (
        <div className="extra mt-8 w-full">
            <div className="bookings flex gap-2 justify-center lg:gap-4 lg:justify-start">
                <button
