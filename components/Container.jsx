                ...
                <div className="w-full sm:w-1/2 p-4 m-5">
                    ...
                    <div className="mt-10 mx-1">
                        <p className="font-semibold text-gray-500">
                            ...
                            plasters; it deals with the very processes of life,
                            which must be understood before they may be guided.
                            – Paracelsus
                            <br /> Your health is just a click away. Book your
                            appointments online and take the first step towards
      ...
      <Blogs /> */}
            <div className="mt-4">
                ...
                <div className="list mx-8 mt-3 flex flex-col gap-3 md:w-1/3 md:mx-32">
                    ...
                    <p>
                        2. Search for your physican here, and contact their
                        office directly.
                    </p>
                    <p>
                        3. View our physicans who are accepting new patients,
